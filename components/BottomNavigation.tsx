...
const BottomNavigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex justify-between items-center py-4 px-6 border-t bg-white border-gray-200 rounded-t-[20px] shadow-lg max-w-md mx-auto">
      ...
      <Link
        href="/medicine"
        className={`flex flex-col items-center ${pathname === "/medicine" ? "text-primary" : "text-gray-500"}`}
      >
        <Pill size={20} />
      ...
      <Link
        href="/chat"
        className={`flex flex-col items-center ${pathname === "/chat" ? "text-primary" : "text-gray-500"}`}
      >
      ...
      <Link
        href="/mypage"
        className={`flex flex-col items-center ${pathname === "/mypage" ? "text-primary" : "text-gray-500"}`}
      >
        <User size={20} />
